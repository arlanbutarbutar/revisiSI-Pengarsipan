...
if (isset($_POST['simpan'])) {
    ...
    $jabatan              = $_POST['jabatan'];  
            ...
            $insert = mysqli_query($db, "INSERT INTO `anggota`(`id_anggota`, `nama_anggota`, `jenis_kelamin`, `alamat`, `nohp`, `jabatan`)
                                        VALUES('$id_anggota','$nama_anggota','$jenis_kelamin','$alamat','$nohp','$jabatan')")
